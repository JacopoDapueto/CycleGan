...
def discriminator_loss(real, generated):
  ...
  #if acc(tf.zeros_like(generated) , generated).numpy() < 0.5:
    #update = True
...
def Discriminator(input_shape, norm_type = 'batchnorm'):
    ...
    x = downsample(64, 4, norm_type , apply_batchnorm=False)(inputs)
    x = downsample(128, 4, norm_type )(x)
    x = downsample(256, 4, norm_type)(x)
    x = downsample(1, 4, norm_type)(x)

    x = Dense(1, input_shape=(None,), activation='sigmoid')(x)
